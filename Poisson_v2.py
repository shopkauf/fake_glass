...
if __name__ == "__main__":
    #offset = (40, -30)
    offset = (0, 0)
    composite_folder = r'C:/Data/glass/composite_cropped320x160/'
    out_folder = r'C:/Data/glass/composite_cropped320x160_Poisson/'

    import os
    files = os.listdir(composite_folder)
    fcount = 0
    for im_name in files:


        img_mask = io.imread(r'C:/Data/glass/Poisson_template/glass_mask.png', as_grey=True)
        img_src = io.imread(r'C:/Data/glass/Poisson_template/white.png').astype(np.float64)
        img_target = io.imread(composite_folder + im_name)
        ...
        img_pro = poisson_blend(img_mask, img_src, img_target,
                                ...
                                #method='src', offset_adj=offset_adj)
        #plt.imshow(img_pro)
        #plt.show()
        io.imsave(out_folder + im_name, img_pro)
